...
"Marcin od Mörk Borga prezentuje.",
"Anuk Schleger prezentuje.",
"Dobra nowina Nechrubela",
"Czy Josilfa Migol jest kretonką?",
"Nechrubel poleca.",
"Anthelia poleca.",
"Verhu poleca.",
"Anuk Schleger poleca.",
"bork bork bork",
"Wyrocznia plugastwa",
"Głos Verhu w Twoim domu",
"Głos Nechrubela w Twoim domu",
"Szczęśliwego Dnia Krwi!",
...
"Nechrubel patrzy.",
"Verhu czuwa.",
"Losowe tabele • OSR • dark fantasy",
"Nigdy nie odpuszczaj goblinowi.",
"Low tech, low life",
"Low tech, high on misery",
"Low Tech. Low Life. High Mortality.",
"In memoriam Dominus Risulus",
"Spodziewaj się kretońskiej inkwizycji.",
"Uważaj na szczury.",
...
"Ratuj się kto może!",
"Nie ma litości.",
"Wiatr dmie z zachodu, znad rozbitych krain.",
"Zgnilizna i odór krwi w każdym podmuchu",
"Przeklęty wędrowcze – czy wyruszysz tam?",
"A kim jesteś ty? Hieną cmentarną o srebrze pobłyskującym między spękanymi paznokciami?",
"A kim jesteś ty? Mistykiem, który odciągnąłby nędzne serce świata z dala od jego nieuniknionej zguby?",
"Majaki proroków zagłady raz za razem potwierdzają się.",
"PEWNEGO DNIA WSZYSTKO I TAK SCZERNIEJE.",
"Wszystko sczernieje i spłonie.",
"Ponury świat niebezpiecznych przygód",
"Niebezpieczne przygody w ponurym świece",
"Niebezpieczne przygody w umierającym świece",
"TO CO NAPISANE MUSI ZOSTAĆ POZNANE.",
"PRZECZYTAŁEŚ TO ŹLE.",
"Wszystkie gobliny noszą w sobie klątwę.",
"Niech waf Zielaf fłogofłafi.",
"Pielgrzymi na Pielgrzymce Zagłady",
"Życie uwięzione i dogorywające w MROCZNYM FORCIE",
"Odległości zakrzywiają się, a ścieżki wypaczają.",
"Bazyliszki są dwa i dwugłowe.",
...
"Odległości zmieniają się. Ścieżki między miejscami krzywią",
"Po prawdzie, nieszczególna wielka to różnica.",
"Od lat nikomu nie dane było ujrzeć słońca.",
"Majaki proroków zagłady raz za razem zyskują potwierdzenie.",
"Może należy się poddać?",
"Co raz zostało spisane, niechaj zawsze będzie znane.",
"Przepowiednie okazały się prawdą absolutną.",
"Bazyliszki są dwa i po dwie głowy mają.",
"Verhu głosi nieodzowną zagładę.",
"Świat umiera nawet teraz.",
"Rzeczywistość próchnieje, jawa staje się snem, a sen — jawą.",
"Akünh, Akünh, Akünh",
"Ku pamięci Muraka, zabitego przez kultystów",
"Ku pamięci Grosztaka, Kraparka i Karubola, którzy zginęli próbując powstrzymać Akünh.",
"Ku pamięci Boröksa Pogromcy Dłoni, który spadł w przepaść.",
"Ku pamięci Bezimiennego, roztrzaskanego na bruku po upadku z wysokości 24 metrów",
"Ku pamięci Gudera, vel Guntera, którego twarz została odgryziona przez gargulca.",
"Ku pamięci Claudera Geiselgusa, który spadł z Lewiatana, pokąsany przez scolopendrę.",
"Ku pamięci Prütora, zaduszonego bąblem różowego szkieleta",
"Ku pamięci Anonima, zabitego przez podziemne pajączaki",
"Ku pamięci Vresiego, zabitego strzałą",
"Ku pamięci Krangremera, znanego też jako Grandemer",
"Ku pamięci Romana",
"Ku pamięci Jana Kowalskiego, który próbował pływać w zbroi.",
"Ku pamięci Błędnego Zwraca Pustkę, bladawca",

"Ku pamięci Rajtuzara, zabitego przez szkielet w Opuszczonej Wieży",
"Ku pamięci Eleny, zabitej przez szkielet w Opuszczonej Wieży",
"Ku pamięci Toraka, rozszarpanego przez krabopająka w Opuszczonej Wieży",
"Ku pamięci Leili, zagryzionej przez wilka w Świątyni",
"Ku pamięci Drudina, który poległ z ręki bobołaka w Świątyni.",
...
"Ku pamięci Euzebiusza Defekatora, którego duch opuścił ciało.",
...
"Ku pamięci Kolbeina",
"Ku pamięci Targurda, zwanego Grubym",
"Ku pamięci Wyrka, zabitego przez Cerbera w Sanktuarium Zielarza",
"Ku pamięci Morgany, zabitej przez chciwość",
...
"Ku pamięci Aleka, Baleka, Caleka i Daleka, bez pokrewieństwa",
"Ku pamięci Arana, który zginął od ciosu minotaura.",
"Ku pamięci Huga, który się spalił.",
...
let MBRandomDiscoveriesWilderness = function (){
  return{
    ...
    list: [
      ...
      "Zatrute źródło",
      "Zrujnowana świątynia - kretońska",
...
createAndAddMonster({
  ...
  specjalneCechy:
    "Szybkie, ulotne i trudne do trafienia (PT14). Te bezcielesne zjawy zawsze wygrywają inicjatywę. Ich dotyk wysysa Siłę, Skupienie i Inicjatywę, zmniejszając je o 1 do końca walki. Wartość: złapany 120s, czaszka 70s, ektoplazma 25s.",
});
createAndAddMonster({
...
createAndAddClass({
  ...
  rolledAbility: [
    ...
    "Lutnia Porządnego Łupnia - gdy na niej grasz, dźwięki tego instrumentu w kształcie topora (k8 obrażeń), sprawiają, że Siła i Skupienie każdego, kto je słyszy, zamieniają się na k6 dni. Kolejne odsłuchania w tym czasie nie dają efektów",
  ],
  numberOfRolledAbilities: false,
  agility: 0, //for abilities use simple modifier (positive or negative value) for more complex cases, use [die, number of dice, modifier]
  presence: 2,
      ...
      saveButton.addEventListener('click', ()=>{
        ...
        let docDefinition = {
         ...
         content: [
             ...
             { text: ar[j].createdCharacterClassDescription, margin: [0, 4, 0, 8]},
             { text: ar[j].createdCharacterPersonality, margin: [0, 4, 0, 8]},
             { text: ar[j].createdCharacterClassBenefitsHeader, bold: true},
             { text: ar[j].createdCharacterClassBenefits, margin: [0, 4, 0, 8]},
             { text: ar[j].createdCharacterHP, margin: [0, 4, 0, 0], fontSize: 16, bold: true},
             { text: ar[j].createdCharacterStrength, margin: [0, 4, 0, 0], bold: true},
             { text: ar[j].createdCharacterAgility, margin: [0, 4, 0, 0], bold: true},
             { text: ar[j].createdCharacterPresence, margin: [0, 4, 0, 0], bold: true},
             { text: ar[j].createdCharacterToughness, margin: [0, 4, 0, 4], bold: true},
             { text: "Broń:", bold: true},
             { text: ar[j].createdCharacterWeapon, margin: [0, 0, 0, 8]},
             { text: "Pancerz:", bold: true},
             { text: ar[j].createdCharacterArmor, margin: [0, 0, 0, 8]},
             { text: "Ekwipunek:", bold: true},
             { text: "Udźwig: siła + 8 przedmiotów", fontSize: 8, margin: [0, 0, 0, 8]},
             ...equipmentParagraphs,
             { text: "______________________"},
             ...equipmentOutsideSlotsParagraphs,
             { text: ar[j].createdCharacterSilver + " szt. srebra", margin: [0, 8, 0, 8]},
             ...
             { text: "Używanie zwojów", margin: [0, 2, 0, 0],bold: true},
