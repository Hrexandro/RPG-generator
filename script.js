...
import { MBNames, MBTowns, VOTENobleNames, wizardNames, MBPaleOneNames, MBDeadGod, maleSlavicNames, unsulliedNames, maleLatinNames, maleRussianNames, maleGaelicNames, mercenaryCompanies } from './names.js'
...
const MBRandomEncounters = function () {
  return {
    ...
    list: [
      ...
      `Wioska - opuszczona, można z niej wyszabrować ${k(6)} racji jedzenia i wody`,
